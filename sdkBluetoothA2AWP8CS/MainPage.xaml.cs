    ...
    public partial class ChatPage : PhoneApplicationPage
    {
        ...
        private void SendMessage_Tap_1(object sender, GestureEventArgs e)
        {
            ...
            for (i = 0; i <= n; i++)
            {
                ...
                screenshotname = String.Format("Screenshooter_{0}", DateTime.Now.Ticks);
        ...
        private string SendMessage(MemoryStream ms)
        {
            ...
            //            // The first is the size of the message.
            //            // The second if the message itself.
            //            //_dataWriter.WriteInt32(ms.Length);
            //            await _dataWriter.StoreAsync();

            //            await _dataReader.LoadAsync(4);
            //            uint messageLen = (uint)_dataWriter.WriteInt32();
            //await _dataWriter.LoadAsync(messageLen);
            //string imageData;
            //         _dataReader.ReadString(messageLen);
        }
        ...
        private void Button_Tap(object sender, GestureEventArgs e)
        {
            ...
            if (i > n)
            {
                MessageBox.Show("The screen Sharing has stopped");
            }
